...
export const HOTKEYS: HotkeyEntry[] = [
  ...
  { section: "Navigation", keys: "", action: "Graph view: open local graph" },
  ...
  { section: "Tabs", keys: "", action: "Focus on tab group to the left / right" },

  // ── Files ─────────────────────────────────────────────────────────────────
  { section: "Files", keys: "⌘N", action: "Create new note" },
  { section: "Files", keys: "", action: "Create note to the right" },
  { section: "Files", keys: "", action: "Duplicate current file" },
  { section: "Files", keys: "", action: "Delete current note" },
  { section: "Files", keys: "Double-click title", action: "Rename current note" },
  { section: "Files", keys: "", action: "Copy file path" },
  { section: "Files", keys: "", action: "Bookmark current note" },
  { section: "Files", keys: "", action: "Bookmark all tabs" },
  { section: "Files", keys: "", action: "Files: Create new folder" },
  { section: "Files", keys: "", action: "Canvas: Create new canvas" },
  ...
  { section: "Editor", keys: "", action: "Zoom in / Zoom out / Reset zoom" },
  { section: "Editor", keys: "", action: "Toggle default mode for new tabs" },
  ...
  { section: "Panels", keys: "", action: "Toggle ribbon" },
  { section: "Panels", keys: "", action: "Show file explorer" },
  { section: "Panels", keys: "", action: "Show bookmarks" },
  { section: "Panels", keys: "", action: "Backlinks: Show backlinks" },
  ...
  { section: "Vault", keys: "", action: "Export vault as a zip" },
  { section: "Vault", keys: "", action: "Import notes from a zip" },
  { section: "Vault", keys: "", action: "Change vault" },
  { section: "Vault", keys: "", action: "Reload app without saving" },
