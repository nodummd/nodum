...
section: Notes
order: 1
summary: The file explorer — creating, opening, moving, colouring and renaming notes and folders, and what the right-click menu can do.
...
- **Open** a note by clicking it — it opens in a new tab (or switches to it if it is already open). Links inside notes reuse the tab you are reading in.
